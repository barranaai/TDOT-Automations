  ...
  roles: [
    { role: 'PrincipalApplicant', label: 'Principal Applicant', required: true, documents: [
      ...
      { code: 'RECLETTERS', name: 'Recommendation Letters (only for Principal Applicant)', category: 'Other',
        guidance: 'Letters describing your skills, strengths and qualities, showing why you are a good fit for the job or opportunity, with examples of your work or achievements, ending with a strong statement of support.' },
    ] },

'use strict';
// OINP Workforce Priority Stream — EXISTING-client pathway (client already
// holds an Express Entry profile with TDOT; this adds the OINP EOI). One of
// the two WPS sub-types added
...
module.exports = {
  caseType: "OINP",
  subType: "Workforce Priority Stream (Existing Client)",
  schemaVersion: 1,

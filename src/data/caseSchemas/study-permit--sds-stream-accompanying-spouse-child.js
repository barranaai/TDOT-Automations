...
module.exports = {
  ...
  schemaVersion: 1,
  source: "Document Checklist Items/Study Permit/Document Checklist- Study Permit- SDS Stream- Accompanying spouse or child.pdf",
  reviewedBy: 'Workflow review (Claude)',
  reviewedAt: '2026-05-13',
  caseFlags: {
    spouseIncluded: { label: 'An accompanying spouse is also applying' },
    childrenIncluded: { label: 'One or more accompanying children are applying' },
    supporterIncluded: { label: 'A supporting family member is providing funds' },
  },
  memberFlags: {
  ...
  roles: [
    { role: 'PrincipalApplicant', label: 'Principal Applicant', required: true, documents: [
      ...
      { code: 'GIC', name: 'Guaranteed Investment Certificate', category: 'Financial' },
      { code: 'SOP', name: 'Statement of Purpose', category: 'Forms' },
      { code: 'WORKEXP', name: 'Proof of work experience', category: 'Other' },
    ] },
    ...
    { role: 'Spouse', label: 'Accompanying Spouse', includeWhen: { caseFlag: 'spouseIncluded' }, documents: [
      ...
      { code: 'GOVTID', name: 'Government issued Identity documents', category: 'Identity' },
      { code: 'MEDICAL', name: 'Upfront Medical exams', category: 'Medical' },
      { code: 'PCC', name: 'Police certificates (PCC) - Highly recommend', category: 'Background' },
      { code: 'INCOME', name: 'Proof/source of Income', category: 'Financial' },
    ...
    { role: 'DependentChild', label: 'Accompanying Child', includeWhen: { caseFlag: 'childrenIncluded' }, multipleAllowed: true, documents: [
      ...
      { code: 'STUDENTDOCS', name: 'If student - school documents and supporting proof of income from parents', category: 'Academic' },
    ] },
  ],
};

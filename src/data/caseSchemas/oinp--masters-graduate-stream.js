...
module.exports = {
  ...
  caseFlags: {
    spouseIncluded: { label: 'Applicant has a non-accompanying spouse/common-law partner' },
    childrenIncluded: { label: 'Applicant has non-accompanying dependent child(ren)' }
  },

  ...
  roles: [
    { role: 'PrincipalApplicant', label: 'Principal Applicant', required: true, documents: [
      ...
      { code: 'EMPPROOF', name: 'Current Employment Proof', category: 'Financial',
        guidance: 'Employment/reference letter on company letterhead with the company’s contact details and the signer’s name and title, hand-signed (typed names are not acceptable), listing all positions held with duties, tenure, full/part-time status, weekly hours, and current salary plus salary at hiring — we can share a template. Also include all paystubs and T4s received so far and the NOA for the last year.' },
      { code: 'WORKEXP', name: 'Proof of work experience (Inside and Outside Canada)', category: 'Financial',
        guidance: 'All paystubs/pay slips for the claimed experience (or bank statements showing salary deposits, or employer letters confirming your annual salary/hourly wage); T4 or Form 16; Notice of Assessment or other tax payment proof (e.g. income tax returns); and employment/reference letters for all periods of qualifying work experience — we can share a template; work contracts are optional. If self-employed: business registration/ownership documents, income tax returns, T4A statements (if self-employed in Canada), client/third-party reference letters with payment details, invoices, and business advertisements.' },
      ...
      { code: 'TRADECERT', name: 'Trade Certificate', category: 'Other',
        guidance: 'If you are working or have worked in a regulated occupation in Ontario that requires a licence or certification, include a copy of your licence(s) or certification(s) from the Ontario College of Trades.' },

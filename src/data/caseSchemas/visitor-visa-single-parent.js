...
const SPONSOR_DOCUMENTS = [
  ...
  { code: 'INCOME',    category: 'Financial', name: 'Proof/source of Income',
    guidance: 'Notice of Assessment for last year (mandatory for income eligibility) and 3 months bank statements with good funds. If salaried: signed job letter on letterhead, at least 3 pay slips, T4. If self-employed: business establishment/incorporation proof, 3 months business bank statements, documents proving the business is legal and genuine.' },

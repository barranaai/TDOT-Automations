/**
 * Bulk import Visitor Visa Outside Canada questionnaire into the
 * "Visitor Visa" and "TRV" groups, using Case Sub Type = "Outside Canada".
 *
 * Usage: node src/scripts/importVisitorVisaOutsideQuestionnaire.js
 */
...
// Target groups
const TARGET_GROUPS = [
  { groupId: 'group_mm1223sz', caseType: 'Visitor Visa', prefix: 'VV-OC'  },
  { groupId: 'group_mm1244hn', caseType: 'TRV',          prefix: 'TRV-OC' },
];
...
const MAIN_QUESTIONS = [
  ...
  { name: 'Sponsor 1 – Name',                                                                category: 'Personal',   inputType: 'Short Text', required: 'Conditional', helpText: '' },
  { name: 'Sponsor 1 – Relationship',                                                        category: 'Personal',   inputType: 'Short Text', required: 'Conditional', helpText: '' },
  { name: 'Sponsor 1 – Full Address in Canada',                                              category: 'Personal',   inputType: 'Long Text',  required: 'Conditional', helpText: '' },
...
// Identical to Main Applicant — no exclusions per document structure.
const DEPENDENT_QUESTIONS = MAIN_QUESTIONS.map((q) => ({
  ...q,
  name: `${q.name} (Dependent)`,
}));

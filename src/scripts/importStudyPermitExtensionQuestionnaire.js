/**
 * Bulk import Study Permit Extension questionnaire (April 2025) into the
 * "Study Permit Extension" group on the Questionnaire Template Board.
 *
 * Usage: node src/scripts/importStudyPermitExtensionQuestionnaire.js
 */
...
const TARGET_GROUPS = [
  { groupId: 'group_mm124nqc', caseType: 'Study Permit Extension', prefix: 'SPE' },
];
...
const QUESTIONS = [
  ...
  { name: 'First Entry to Canada – Date (DD/MM/YYYY)',                                       category: 'Personal',   inputType: 'Date',       required: 'Mandatory',   helpText: 'Format: DD/MM/YYYY' },
  { name: 'First Entry to Canada – Location',                                                category: 'Personal',   inputType: 'Short Text', required: 'Mandatory',   helpText: '' },
  { name: 'First Entry to Canada – Status',                                                  category: 'Personal',   inputType: 'Short Text', required: 'Mandatory',   helpText: '' },
  { name: 'Latest Entry to Canada – Date (DD/MM/YYYY)',                                      category: 'Personal',   inputType: 'Date',       required: 'Mandatory',   helpText: 'Format: DD/MM/YYYY' },
  { name: 'Latest Entry to Canada – Location',                                               category: 'Personal',   inputType: 'Short Text', required: 'Mandatory',   helpText: '' },
  { name: 'Latest Entry to Canada – Status',                                                 category: 'Personal',   inputType: 'Short Text', required: 'Mandatory',   helpText: '' },

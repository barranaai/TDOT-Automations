/**
 * Bulk import TRV (Temporary Resident Visa) questionnaire (April 2025) into
 * the "TRV Copy (Need to verify)" group on the Questionnaire Template Board.
 *
 * Single applicant type. TRV-specific fields include Language test report
 * and USCIS number questions not present in the Visitor Visa questionnaire.
 *
 * Usage: node src/scripts/importTRVQuestionnaire.js
 */
...
const TARGET_GROUPS = [
  { groupId: 'group_mm19t4n2', caseType: 'TRV', prefix: 'TRV' },
];
...
const QUESTIONS = [
  ...
  { name: 'Do you have a valid Language test report?',                                                   category: 'Personal',    inputType: 'Dropdown',   required: 'Mandatory',   helpText: '' },
  { name: 'Are you a lawful permanent resident of the US with a valid USCIS number?',                   category: 'Personal',    inputType: 'Dropdown',   required: 'Mandatory',   helpText: '' },
  ...
  { name: 'First Entry to Canada – Status',                                                              category: 'Personal',    inputType: 'Short Text', required: 'Conditional', helpText: 'E.g., Visitor, Student, Worker.' },
  ...
  { name: 'Travel – Start Date (DD/MM/YYYY)',                                                            category: 'Travel',      inputType: 'Date',       required: 'Mandatory',   helpText: 'Provide travel history for the past 5 years (including your home country). Include full dates (DD-MM-YYYY) and your status (Student, Visitor, Worker, Citizen, etc.).' },

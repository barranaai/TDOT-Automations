/**
 * One-off — add the "Consult Countersign" text column to the Lead Board.
 * Stores the consultation-agreement e-sign envelope state as JSON:
 *   { "clientEnvelopeId": "…", "clientItemId": "…",       ← client envelope (consult-<leadId>)
 *     "envelopeId": "…", "itemId": "…", "signUrl": "…",   ← RCIC countersign envelope (consult2-<leadId>)
 ...
 *
 *   node scripts/add-consult-countersign-column.js            # dry-run
 *   node scripts/add-consult-countersign-column.js --write    # create if missing
 */
...
const COL = { key: 'consultCountersign', title: 'Consult Countersign', type: 'text' };
